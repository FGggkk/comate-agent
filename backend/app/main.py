...
def create_app() -> FastAPI:
    ...
    # 注册路由
    from app.api import auth, chat, souls, memories, interview, reminders, user, sessions, messages, finance, travel, shopping, admin_auth, admin_dashboard, admin_codes, admin_users, admin_settings, admin_stats, admin_admins, billing
