...
const navs = [
  ...
  { to: '/company-knowledge', label: '公司制度', icon: '<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M4 3.5h9.5a2.5 2.5 0 012.5 2.5v10.5H6.5A2.5 2.5 0 014 14V3.5z"/><path d="M7 6h6M7 9h6M7 12h4"/></svg>' },
